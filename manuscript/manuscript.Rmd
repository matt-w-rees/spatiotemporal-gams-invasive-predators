---
title: Joint spatiotemporal models reveal dramatic shifts in mesopredator diel activity across individuals, habitat types and apex predator activity levels
author:
  - name: Matthew W. Rees
...
### Variation in predator diel activity across vegetation types
...
### Variation in feral cat diel activity across apex predator activity
...
```{r ind, out.width="100%", fig.cap = "Individual variations in feral cat diel activity patterns across the Glenelg region (A) and wet forests of the western Otway Ranges (B) in south-west Victoria, Australia. Dotted, vertical lines represent average sunrise and sunset times. Shaded areas indicate 95\\% confidence intervals."}
